...
@section('content')
    ...
    <div class="flex justify-between mb-4">
        <a href="/tambahpeserta" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Tambah</a>
    </div>

    <div class="mt-4">
        <form action="/crud" method="GET" class="flex items-center">
            <input type="search" id="inputSearch" name="search" class="border border-gray-300 rounded-lg p-2 w-full"
                placeholder="Cari data peserta" required>
            <button type="submit" class="ml-2 bg-blue-500 hover:bg-blue-700 text-white py-2 px-4 rounded">Cari</button>
        </form>
    </div>
